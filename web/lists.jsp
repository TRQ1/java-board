        ...
        <td width="1000" valign="top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <%
                    ...
                    //ArrayList<BoardVo> voList = boardDao.sqlBoardList(request, bc, 1);
            ...
            %>
                            <a href="detail.jsp?id=<%=id%>&pg=<%=pg%><%=bc%>"><%=title %>
                                <%
                } else if (postStatus.equals("deleted") && commentCount != 0) {
            %>
                            <a href="detail.jsp?id=<%=id%>&pg=<%=pg%>" onClick="alert('삭제된 글입니다.')"><%=title %>
                                (<%=commentCount%>)
                                    <%
                } else if (postStatus.equals("deleted") && commentCount == 0) {
            %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr align="center">
                        <br>
                        <div id="searchForm">
                            <form name=searchForm method=post action=lists.jsp?pg=<%=pg%>&bc=<%=bc%>>
                                <select name="opt">
                    ...
                    <tr align="right">
                        <td><input type=button value="글쓰기"
                                   OnClick="window.location='write.jsp?pg=<%=pg%>&bc=<%=bc%>&w=1'"></td>
                    </tr>
                </table>
            </table>
